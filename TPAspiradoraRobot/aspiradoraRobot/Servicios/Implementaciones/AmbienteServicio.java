...
public class AmbienteServicio implements iAmbiente {
    ...
    public AmbienteServicio(int filas, int columnas) {
        ambiente = new Ambiente(filas, columnas);
    }
    ...
    public void ubicarObstaculos() {
        double cantidadSuelo = ambiente.getAmbiente().length * ambiente.getAmbiente()[0].length;
